                        ...
                        <ul>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="static/images/blank.gif" data-echo="static/images/products/product-small-04.jpg" />
                                        </a>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="static/images/blank.gif" data-echo="static/images/products/product-small-05.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="static/images/blank.gif" data-echo="static/images/products/product-small-06.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="static/images/blank.gif" data-echo="static/images/products/product-small-07.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="static/images/blank.gif" data-echo="static/images/products/product-small-08.jpg" />
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-3 no-margin">
                                        <a href="#" class="thumb-holder">
                                            <img alt="" src="static/images/blank.gif" data-echo="static/images/products/product-small-09.jpg" />
                                        </a>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="static/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="static/images/payments/payment-master.png"></li>
                        <li><img alt="" src="static/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="static/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
