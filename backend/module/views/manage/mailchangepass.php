...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 box">
        <div class="content-wrap">
            ...
            <?php echo $form->field($model,'name')->hiddenInput();?>
            <?php echo $form->field($model,'pass')->textInput(["class" => "span12","placeholder" => "新密码"]);?>
            <?php echo $form->field($model,'confirmPass')->passwordInput(["class" => "span12","placeholder" => "确认密码"]);?>
            <a href="<?php echo yii\helpers\Url::to(['public/login']);?>" class="forgot">返回登陆?</a>
            <div class="form-group field-remember-me">
                <?= Html::submitButton('修改密码', ['class' => 'btn-glow primary login', 'name' => 'login-button']) ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
